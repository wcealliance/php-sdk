...
class methodTest extends baseTest
{
    ...
    {
        parent::_before();
        $this->reflected = new \ReflectionClass($this->API);
    }
    ...
    {
        $e = $this->API->getConfig('api_endpoint');
        $v = 'v' . $this->API->getConfig('api_version');
        $data = array(
            'getMe' => array(
    ...
    private function call($method, $args)
    {
        ...
        return $method->invokeArgs($this->API, $re_args);
    }
